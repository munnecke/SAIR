...
keywords: ["five-sigma standard","scientific discovery confidence","statistical validation","AI-generated scores","overoptimistic AI","Gaussian statistics","peer review","epistemology","discovery claim","AI-augmented analysis"]
---
...
[9:37:12] So there's basically methods of fixing that but they're nowhere near at this stage at the level where if we use AI in our analysis that we could convince each other that we make a discovery.

[9:37:26] We spent a whole day today talking about AI and science and no one mentioned how are we going to make a discovery with AI and I think it's because it's a totally unsolved problem.
